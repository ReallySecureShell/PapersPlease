...
At this time it is unknown exactly why the GGW server crashes when receiving such a request. In addition, any index number 8 or 9 digits in length will cause the GGW server to crash.
